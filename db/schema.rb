...
ActiveRecord::Schema.define(:version => 20130119075108) do
  ...
  create_table "restaurant_dishes", :force => true do |t|
  ...
  create_table "suburb_streets", :force => true do |t|
    t.integer  "suburb_id"
    t.integer  "street_id"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  ...
  create_table "sys_language_strings", :force => true do |t|
    t.string   "string"
  ...
  create_table "sys_strings", :force => true do |t|
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end
